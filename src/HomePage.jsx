...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-500 via-blue-200 to-white bg-gradient-to-b from-blue-500 via-blue-200 to-white flex flex-col justify-center items-center space-y-6">
